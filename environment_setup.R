...
write.csv(final_levels_df,paste0(getwd(),"/data/cowboy_data.csv"))
...
write.csv(final_levels_df,paste0(getwd(),"/data/reds_rocket.csv"))
...
write.csv(final_levels_df,paste0(getwd(),"/data/reds_brahmos.csv"))
...
write.csv(final_levels_df,paste0(getwd(),"/data/blackout.csv"))
...
write.csv(final_levels_df,paste0(getwd(),"/data/gaps_strategy.csv"))
