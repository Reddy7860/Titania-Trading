...
temp_query = paste0('{"execution_date": { "$gte" :  "',as.character(Sys.Date()), '" }',',"Stock":"%5ENSEI" }')
...
temp_query = paste0('{"execution_date": { "$gte" :  "',as.character(Sys.Date()), '" }',',"client_id":"J95213","Stock":"%5ENSEI" }')
