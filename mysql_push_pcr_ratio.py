...
for i in stock:
    ...
    for dt in range(0,len(date_list)):
        ...
        try:
            ...
            stock = ''
            if i == '%5ENSEI':
                path = '/Users/apple/Desktop/Python_Stocks_Automation/Options_data/Nifty/' + date_list[dt].strftime('%Y-%m-%d') +'_Futures_Options_Signals.csv'
                stock = 'Nifty'
            else:
                path = '/Users/apple/Desktop/Python_Stocks_Automation/Options_data/BankNifty/' + date_list[dt].strftime('%Y-%m-%d') +'_Futures_Options_Signals.csv'
                stock = 'BankNifty'
