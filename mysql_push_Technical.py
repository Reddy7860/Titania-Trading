...
tables = ['technical_indicator_1_minutes', 'technical_indicator_5_minutes', 'technical_indicator_15_minutes', 'technical_indicator_30_minutes', 'technical_indicator_60_minutes','technical_indicator_1_day']

stock_tables = ['Stocks_data_1_minutes', 'Stocks_data_5_minutes', 'Stocks_data_15_minutes', 'Stocks_data_30_minutes', 'Stocks_data_60_minutes','Stocks_data_1_day']
...
for idx in range(0,len(sql_df)):
    ...
    if stock == '%5ENSEI':
       ...
       'Pivot_Call', 'PCR_Call', 'BB_Call', 'VWAP_Call', 'SuperTrend_Call']]
        ...
        collection.insert_many(temp_result.to_dict('records'))
