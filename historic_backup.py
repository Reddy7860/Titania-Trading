...
def upload_data_gbq(data,destination_table):
    try:
...
def main():
    ...
    logging.basicConfig(filename ='/Users/apple/Downloads/EC2_Edit/historic_backup_'+ str(datetime.now(timezone("Asia/Kolkata")).strftime("%Y-%m-%d")) +'.log',
                        level = logging.DEBUG)
