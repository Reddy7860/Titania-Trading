...
request = session.get(nse_url, headers=headers, timeout=5)
...
money_control_url = "https://www.moneycontrol.com/india/indexfutures/nifty/9/2022-10-27/FUTIDX/XX/0.00/true"
...
fut_dir_name = '/Users/apple/Desktop/Python_Stocks_Automation/Futures_data/Nifty/' + str(datetime.now(timezone("Asia/Kolkata")).strftime("%d-%m-%Y"))
...
page = requests.get(money_control_url)
...
futures_dir_name = '/Users/apple/Desktop/Python_Stocks_Automation/Futures_Updated_data/Nifty/' + str(datetime.now(timezone("Asia/Kolkata")).strftime("%d-%m-%Y"))
...
for i in range(0,len(current_strike_prices)):
  ...
  for idx in range(0,len(temp_data)):
    dir_name = '/Users/apple/Desktop/Python_Stocks_Automation/Options_data/Nifty/'+str(temp_data.loc[idx,"expirydate"])
...
fut_dir_name = '/Users/apple/Desktop/Python_Stocks_Automation/Futures_data/BankNifty/' + str(datetime.now(timezone("Asia/Kolkata")).strftime("%d-%m-%Y"))
...
futures_dir_name = '/Users/apple/Desktop/Python_Stocks_Automation/Futures_Updated_data/BankNifty/' + str(datetime.now(timezone("Asia/Kolkata")).strftime("%d-%m-%Y"))
...
for i in range(0,len(current_strike_prices)):
  ...
  temp_data = pd.DataFrame(temp_data)
  for idx in range(0,len(temp_data)):
    dir_name = '/Users/apple/Desktop/Python_Stocks_Automation/Options_data/BankNifty/'+str(temp_data.loc[idx,"expirydate"])
    file_name = dir_name+'/' + str(temp_data.loc[idx,"strikeprice"])+'.csv'
    final_data  = temp_data.loc[temp_data['expirydate'] == temp_data.loc[idx,"expirydate"]]
